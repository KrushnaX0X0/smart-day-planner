...
function Hero() {
  return (
    <div className='h-screen w-screen bg-black flex justify-center items-center flex-col relative'>
       <div className=' z-10 '>
         <h1 className='text-6xl text-amber-50 inline-block font-semibold'><span className='text-8xl font-bold text-amber-300 font2 '> Plan </span> Your Day <br />  <span className=' ml-32'> Smarter with <span className='text-8xl font-bold text-amber-300 font2 '>AI</span> <img src={brain.src} alt="hiii" className='h-20 inline-block up-down-animation '/></span></h1>
       </div>
